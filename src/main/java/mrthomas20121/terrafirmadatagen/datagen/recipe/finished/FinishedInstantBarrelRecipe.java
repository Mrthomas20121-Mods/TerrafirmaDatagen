...
public record FinishedInstantBarrelRecipe(ResourceLocation id, JsonElement itemInput, JsonElement fluidInput, ItemStackProvider result, FluidStack fluidResult, SoundEvent sound) implements FinishedRecipe {
